...
export default function DiscoverBlock({
  ...
  return (
    <div data-test="discover-block" className="discover-block">
      <div data-test="discover-block-header" className="discover-block__header">
        <h2>{text}</h2>
        <span />
        {data.length ? (
